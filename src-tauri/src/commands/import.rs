...
/// Lists the immediate children of `rel` inside an instance's game dir, for the
/// export dialog's lazy file tree. `rel` uses '/' separators ("" = game root).
#[tauri::command]
...
/// Writes UTF-8 text to a path (used for saving exported mod lists).
#[tauri::command]
